/*
    Implementación de la interfaz DS, definida en "DS.h", para un
    grafo.
...
/*
    ...
    de dato aún no ha sido definido, ya que DSG también es un
...
class DSG: public DS<type>{
    ...
    public:
        ...
        */
        ...
        /* La operación de inserción sin datos adicionales no es aplicable
           a un grafo.                                                    */
        ...
        */
        void insert(int id, type value) override {
            ...
            if(G == NULL){
                ...
                //Si el grafo no está vacío, el nuevo nodo no será
                //el nodo de entrada al grafo
                temp->entry = false;
        ...
        */
        ...
        /* La operación de inversión de contenido no es aplicable a un grafo. */
