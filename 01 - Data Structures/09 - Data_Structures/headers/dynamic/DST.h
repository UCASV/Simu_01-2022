/*
    Implementación para un árbol binario de búsqueda.
...
/*
    ...
    de modo que DST hereda de:
        ...
        - measurable, ya que es posible obtener la altura de un árbol
          binario de búsqueda.
    ...
    embargo, el tipo de dato aún no ha sido definido, ya que DST
